...
CFLAGS = -c -g -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wctor-dtor-privacy -Wdisabled-optimization -Wformat=2 -Winit-self -Wlogical-op -Wmissing-declarations -Wmissing-include-dirs -Wold-style-cast -Woverloaded-virtual -Wredundant-decls -Wshadow -Wsign-conversion -Wsign-promo -Wstrict-null-sentinel -Wstrict-overflow=5 -Wswitch-default -Wundef -Wno-unused -Wconversion -Winline -std=c++17

all: The_spell clean

The_spell: Main.o Entity.o Player.o ResourceManager.o BigRect.o Animation.o getInput.o Camera.o SmartRect.o Tile.o CoreFunctions.o Enemy.o
...
Enemy.o:
	$(CC) $(CFLAGS) Enemy/Core/Enemy.cpp
