...
CFLAGS = -c -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wctor-dtor-privacy -Wdisabled-optimization -Wformat=2 -Winit-self -Wlogical-op -Wmissing-declarations -Wmissing-include-dirs -Wnoexcept -Wold-style-cast -Woverloaded-virtual -Wredundant-decls -Wshadow -Wsign-conversion -Wsign-promo -Wstrict-null-sentinel -Wstrict-overflow=5 -Wswitch-default -Wundef -Werror -Wno-unused -Wconversion -Winline -std=c++17

all: The_spell clean

The_spell: main.o Entity.o Player.o ResourceManager.o BigRect.o Animation.o getInput.o
	$(CC) -no-pie *o -o The_spell -lpthread -lX11 -lGL -lXrandr -lfreetype -ltgui -lsfml-graphics -lsfml-window -lsfml-system
